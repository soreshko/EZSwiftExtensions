...
extension String {
    ...
    public func bold() -> NSAttributedString {
        let boldString = NSMutableAttributedString(string: self, attributes: [AttributedStringKey.font: UIFont.boldSystemFont(ofSize: UIFont.systemFontSize)])
        return boldString
    }
    ...
    public func underline() -> NSAttributedString {
        ...
        let underlineString = NSAttributedString(string: self, attributes: [AttributedStringKey.underlineStyle: styleSingle.rawValue])
    ...
    public func italic() -> NSAttributedString {
        let italicString = NSMutableAttributedString(string: self, attributes: [AttributedStringKey.font: UIFont.italicSystemFont(ofSize: UIFont.systemFontSize)])
        return italicString
    }
    ...
    public func height(_ width: CGFloat, font: UIFont, lineBreakMode: NSLineBreakMode?) -> CGFloat {
        var attrib: [AttributedStringKey: Any] = [AttributedStringKey.font: font]
        if lineBreakMode != nil {
            let paragraphStyle = NSMutableParagraphStyle()
            paragraphStyle.lineBreakMode = lineBreakMode!
            attrib.updateValue(paragraphStyle, forKey: AttributedStringKey.paragraphStyle)
        }
    ...
    public func color(_ color: UIColor) -> NSAttributedString {
        let colorString = NSMutableAttributedString(string: self, attributes: [AttributedStringKey.foregroundColor: color])
        return colorString
    }
    ...
    public func colorSubString(_ subString: String, color: UIColor) -> NSMutableAttributedString {
        ...
        for range in ranges {
            attrText.addAttribute(AttributedStringKey.foregroundColor, value: color, range: range)
        }
        return attrText
    }
